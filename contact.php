			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="#" data-toggle="modal" data-target="#myModal1"><i class="fa fa-th"></i><span>Apps</span></a></li>
						...
						<li class="active"><a href="contact.php"><i class="fa fa-thumb-tack"></i><span>Contact</span></a>
					...
					<div class="profile_details">		
						  <div class="col-md-4 serch-part">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Search for Songs Artists & More" style="width:250px;">
                                </div>
							</div>
							  <!-- search-scripts -->
							...
							<div id="page-wrapper">
								...
								<div class="tittle-head">
									...
									<div class="contact-left">
										<p class="phn">+91981540029</p>
										<p class="phn-bottom">PHASE 5 MOHALI
											</p>
				...
				<div class="footer-grid">
					...
					<ul class="list1">
					 ...
					 <div class="footer-grid footer-grid_last">
						...
						<p class="email">Email : &nbsp;<span><a href="mailto:mail@example.com">jadhavarpit100@gmail.com</a></span></p>
						<p class="email">Email : &nbsp;<span><a href="mailto:mail@example.com">vanishakaler95@gmail.com</a></span></p>	
					 </div>
					 <div class="clearfix"> </div>
				</div>
			</div>
