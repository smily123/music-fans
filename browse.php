			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="blog.html"><i class="lnr lnr-book"></i><span>Blog</span></a></li>
						<li class="active"><a href="#"><i class="lnr lnr-heart"></i>  <span>My Favourities</span></a> 
							</li>
						<li class="active"><a href="contact.html"><i class="fa fa-thumb-tack"></i><span>Contact</span></a>
 	 ...
 	 <!-- /w3l-agile-info -->
			  ...
			  <!--body wrapper end-->
                ...
                <div class="footer-grid footer-grid_last">
                    ...
                    <p class="f_text">Phone: &nbsp;&nbsp;&nbsp;9815400289q</p>
