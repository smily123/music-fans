    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html"><img  src=https://www.makemusic.com/wp-content/themes/makemusic/images/background/logo.png height="30px"><span>c</span></a></h1>
			</div>
			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
                    ...
                    <li class="active"><a href="radio.html"><i class="camera"></i> <span>Radio</span></a></li>
                    <li class="active"><a href="#" data-toggle="modal" data-target="#myModal1"><i class="fa fa-th"></i><span>Mail Box </span></a></li>
                    <li class="active"><a href="radio.html"><i class="lnr lnr-users"></i> <span>Artists</span></a></li>
                    <li class="active"><a href="browse.html"><i class="lnr lnr-music-note"></i> <span>Albums</span></a></li>
                    <li class="active"><a href="browse.html"><i class="lnr lnr-indent-increase"></i> <span>Browser</span></a>
                    </li>
                    <li class="active"><a href="#"><i class="lnr lnr-heart"></i>  <span>My Favourities</span></a>
                    </li>
                    <li class="active"><a href="contact.html"><i class="fas fa-thumb-tack"></i><span>Contact</span></a>
                    </li>
